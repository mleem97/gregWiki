...
const config = {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      style: 'primary',
      items: [
        { type: 'docSidebar', sidebarId: 'wikiSidebar', label: '🚀 Start', position: 'left' },
        { to: '/wiki/reference/greg-hooks-catalog', label: '📡 API', position: 'left' },
        { to: '/wiki/development/modding-guides/csharp-modding', label: '🎓 Guides', position: 'left' },
        { to: '/wiki/development/ui/architecture', label: '🖥️ UI', position: 'left' },
        { to: '/wiki/community/multiplayer-architecture', label: '⚙️ Advanced', position: 'left' },
        { to: '/wiki/tools/overview', label: '🧰 Tools', position: 'left' },
        { to: '/wiki/development/roadmap/overview', label: '🗺️ Roadmap', position: 'left' },
        {
          ...
          items: [
            ...
            { to: '/wiki/development/modding-guides/rust-modding',       label: 'Rust' },
            { to: '/wiki/development/modding-guides/typescript-modding', label: 'TypeScript' },
          ],
        },
