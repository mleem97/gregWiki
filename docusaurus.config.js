    ...
    navbar: {
      ...
      items: [
        ...
        { type: 'docSidebar', sidebarId: 'tutorialsSidebar',      label: '🎓 Tutorials',       position: 'left' },
        {
          ...
          position: 'right',
          items: [
            { to: '/wiki/02_development/modding-guides/csharp-modding',     label: 'C#' },
            { to: '/wiki/02_development/modding-guides/lua-modding',        label: 'Lua' },
            { to: '/wiki/02_development/modding-guides/rust-modding',       label: 'Rust' },
            { to: '/wiki/02_development/modding-guides/typescript-modding', label: 'TypeScript' },
          ],
        },
