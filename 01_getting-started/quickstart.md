...
## 6. Next Steps
- **[API Reference](/docs/02_development/api-reference/services-overview)** - Full method list.
- **[Hooks Catalog](/docs/02_development/api-reference/hooks-catalog)** - Available events.
