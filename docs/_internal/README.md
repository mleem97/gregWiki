...
| **Meta** | [`meta/`](./meta/) | Workshop, devserver, backlog; [architecture principles](../02_development/hooks-library/system-hooks.md#architecture-principles) (ModManager → Framework → Plugins → Mods). |
