...
description: Canonical runtime hook catalog (`greg.*`) generated from GregNativeEventHooks and EventIds.
---
...
:::tip Canonical runtime surface
This page is the runtime source for hook/event names used by `GregEventDispatcher` and native bridge mappings.
